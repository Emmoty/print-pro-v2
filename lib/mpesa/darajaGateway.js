/**
 * ==============================================================================
 * CloudPrint Pro - Safaricom Daraja M-Pesa Low-Level API Gateway
 * ==============================================================================
 * Production & Sandbox Daraja Gateway:
 * - Persistent HTTP/1.1 TLS Keep-Alive Connection Pool
 * - Automated OAuth 2.0 Token Generation with Preemptive Caching
 * - Kenyan Phone Number Normalization Standardizer
 ...
 * Supports: 07XXXXXXXX, 01XXXXXXXX, 7XXXXXXXX, 1XXXXXXXX, +254XXXXXXXXX, 254XXXXXXXXX
 */
...
/**
 * Standard Safaricom Result Code Mappings
 */
const RESULT_CODES = {
  0: { status: 'SUCCESS', message: 'Payment authorized and accepted by Safaricom.' },
  1: { status: 'FAILED', message: 'Insufficient M-Pesa balance to complete transaction.' },
  1001: { status: 'FAILED', message: 'Insufficient M-Pesa balance to complete transaction.' },
  1032: { status: 'CANCELLED', message: 'Transaction was cancelled or rejected by user on phone.' },
